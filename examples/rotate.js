...
http
  .createServer(function (req, res) {
    ...
    output +=
      'document.getElementById("message").innerHTML = "The piece of javascript also inside the head tag wasn\'t touched :)";';
    output +=
      "}</script></head><body><h3>A simple example of injecting some css to rotate an image into a page before it is rendered.</h3>";
    output +=
      '<image src="http://i.imgur.com/fpMGL.png" /><div id="message"></div></body></html>';
    res.end(output);
  })
  .listen(9000);
